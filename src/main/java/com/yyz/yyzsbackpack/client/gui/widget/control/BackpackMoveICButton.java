...
public class BackpackMoveICButton extends Button {
    ...
    protected void extractContents(@NonNull GuiGraphicsExtractor graphics, int mouseX, int mouseY, float delta) {
        ...
        if (this.isHovered()) {
            List<FormattedCharSequence> tooltipLines = List.of(
                    Component.translatable("yyzsbackpack.button.moveic.line1").getVisualOrderText(),
                    Component.translatable("yyzsbackpack.button.moveic.line2").getVisualOrderText(),
                    Component.translatable("yyzsbackpack.button.moveic.line3").getVisualOrderText(),
                    Component.translatable("yyzsbackpack.button.moveic.line4").getVisualOrderText()
            );
    ...
    public void onClick(MouseButtonEvent event, boolean doubleClick) {
        ...
        ClientPacketDistributor.sendToServer(new MoveIToContainerC2SPacket(mode));
    }
}