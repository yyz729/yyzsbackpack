...
public class BackpackManager {
    ...
    public static final ResourceLocation BACKSLOT_TEXTURE = ResourceLocation.fromNamespaceAndPath(Backpack.MOD_ID, "item/backslot");
    ...
    public static void renderBackpackBackground(GuiGraphics context, int x, int y,
        ...
        context.blit(RenderType::guiTextured,BACKPACK_TEXTURE, left, top, u, 0, width, 174, 462, 174);
    }
