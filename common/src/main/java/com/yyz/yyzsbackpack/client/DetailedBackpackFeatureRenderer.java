...
public class DetailedBackpackFeatureRenderer extends RenderLayer<AbstractClientPlayer, PlayerModel<AbstractClientPlayer>> {
    ...
    public void render(PoseStack poseStack, MultiBufferSource multiBufferSource, int i, AbstractClientPlayer entity, float f, float g, float h, float j, float k, float l) {
        if (shouldRender(entity)) {
            renderBackpack(poseStack, multiBufferSource, entity, i,h);
        }
    }
    ...
    private ResourceLocation getTexture(Player player) {
        return new ResourceLocation(Backpack.MOD_ID, "textures/backpack/backpack.png");
    }
