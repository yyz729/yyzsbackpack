...
public final class BackpackScreenHelper {
    ...
    public static void addBackpackBackground(AbstractContainerScreen<?> screen,
        ...
        int x = ((ScreenAccessor<?>) screen).yyzsbackpack_getLeftPos() + data.backgroundX() + offsetX;
        int y = ((ScreenAccessor<?>) screen).yyzsbackpack_getTopPos() + data.backgroundY() + offsetY;
