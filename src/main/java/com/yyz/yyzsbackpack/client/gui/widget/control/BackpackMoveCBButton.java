...
import com.yyz.yyzsbackpack.network.packets.control.MoveCToBackpackC2SPacket;
...
public class BackpackMoveCBButton extends Button {
    ...
    public BackpackMoveCBButton(int x, int y) {
    ...
    protected void extractContents(@NonNull GuiGraphicsExtractor graphics, int mouseX, int mouseY, float delta) {
        ...
        if (this.isHovered()) {
            List<FormattedCharSequence> tooltipLines = List.of(
                    Component.translatable("yyzsbackpack.button.movecb.line1").getVisualOrderText(),
                    Component.translatable("yyzsbackpack.button.movecb.line2").getVisualOrderText(),
                    Component.translatable("yyzsbackpack.button.movecb.line3").getVisualOrderText(),
                    Component.translatable("yyzsbackpack.button.movecb.line4").getVisualOrderText()
            );
    ...
    public void onClick(MouseButtonEvent event, boolean doubleClick) {
        ...
        ClientPacketDistributor.sendToServer(new MoveCToBackpackC2SPacket(mode));
    }
}