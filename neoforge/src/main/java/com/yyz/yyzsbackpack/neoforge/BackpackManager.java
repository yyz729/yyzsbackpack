...
public class BackpackManager {
    ...
    public static void saveBackpackContents(Container inventory, ItemStack backpackStack) {
        ...
        // 设置数据组件
        backpackStack.set(com.yyz.yyzsbackpack.BackpackPlatform.getBackpackItemsComponent(), items);
    }

    // 从数据组件恢复背包内容
    public static void restoreBackpackContents(Container inventory, ItemStack backpackStack) {
        // 获取数据组件
        List<ItemStack> items = backpackStack.get(com.yyz.yyzsbackpack.BackpackPlatform.getBackpackItemsComponent());
