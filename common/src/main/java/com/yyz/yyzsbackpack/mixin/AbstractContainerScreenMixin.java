...
public abstract class AbstractContainerScreenMixin<T extends AbstractContainerMenu> extends Screen implements BackpackScreen {
    ...
    private boolean handleMouseClicked(AbstractContainerScreen<?> instance, double mouseX, double mouseY,
        ...
        return menu instanceof BackpackMenu ?
                BackpackHelper.isClickOutsideExtendedBounds(
                        inventory,
                        hasClickedOutside(mouseX, mouseY, leftPos, topPos, button),
                        mouseX, mouseY, leftPos, topPos, imageWidth, imageHeight,
                        shouldRenderBackpack,
                        (BackpackMenu) this.menu // 传递renderCondition
                ) : hasClickedOutside(mouseX, mouseY, leftPos, topPos, button);
    }
    ...
    private void initializeFields(AbstractContainerMenu handler, Inventory inventory, Component component, CallbackInfo ci) {
        ...
        this.shouldRenderBackpack = BackpackHelper.shouldRenderBackpack(handler, this.inventory);
